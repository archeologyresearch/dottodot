...
# --- KONFIGURACJA ---
# Ścieżka do modelu Vosk (lokalnie, bez pobierania z internetu)
...
def ensure_model():
    """Sprawdza, czy model istnieje lokalnie. NIE pobiera z internetu."""
    if os.path.isdir(MODEL_DIR):
        print(f"Model znaleziony lokalnie: {MODEL_DIR}")
        return MODEL_DIR
    else:
        print(f"BŁĄD: Nie znaleziono modelu w folderze '{MODEL_DIR}'.")
        print("Upewnij się, że folder z modelem jest w tym samym katalogu co skrypt.")
...
def main():
    ...
    # 2. Przygotuj model Vosk (tylko lokalnie!)
